/**
 * Created by jszh on 2019/2/19.
 */
import React, {Component} from 'react'
import {View, TouchableOpacity, Text, StyleSheet, Image, ScrollView} from 'react-native'
import {commonStyle} from '../../../../utils/commonStyle'
import {Actions} from 'react-native-router-flux'
import CommentList from '../../z_reading/commentList'
                ...
                <View style={{marginHorizontal: 10}}>
                    <View style={styles.playPanel}>
                        ...
                        <View style={{alignItems: 'flex-end'}}>
                            <Image style={{width: 60, height: 15}}
                                   source={require('../../../../assets/images/xiami_right.png')}/>
                            <TouchableOpacity onPress={() => this.playing()}>
                    ...
                    <View style={styles.toolBar}>
                        <TouchableOpacity onPress={() => this.setState({contentMode: 0})}>
                            <Image style={{width: 50, height: 50}}
                                   source={require('../../../../assets/images/music_story_default.png')}/>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.setState({contentMode: 1})}>
                            <Image style={{width: 50, height: 50}}
                                   source={require('../../../../assets/images/music_lyric_default.png')}/>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.setState({contentMode: 2})}>
                            <Image style={{width: 50, height: 50}}
                                   source={require('../../../../assets/images/music_about_default.png')}/>
                        </TouchableOpacity>
                    </View>
                    {
                        this.state.contentMode === 0 ?
                            <View style={styles.descStyle}>
                                <Text
                                    style={{fontSize: 20, fontWeight: 'bold', lineHeight: 30}}>{data.story_title}</Text>
                                <Text style={{
                                    color: commonStyle.textGrayColor,
                                    fontSize: 13,
                                    marginTop: 30
                                }}>{`文 / ${author.user_name}`}</Text>
                                <Text style={{
                                    fontSize: 14,
                                    color: commonStyle.textBlockColor,
                                    lineHeight: 28
                ...
                <View style={styles.active}>
                    ...
                    <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}}>
                        <Image style={{width: 40, height: 40}}
                               source={require('../../../../assets/images/comment_image.png')}/>
                    ...
                    >
                        <Image style={{width: 40, height: 40}}
                               source={require('../../../../assets/images/share_image.png')}/>
                ...
                <View style={{marginHorizontal: 10}}>
                    ...
                    <View style={{flexDirection: 'row', marginTop: 10, marginBottom: 20, alignItems: 'center'}}>
                        ...
                        <View style={{marginLeft: 10, flex: 1, justifyContent: 'center'}}>
                            ...
                            {
                                author.summary ? <Text style={{
                                    color: commonStyle.textGrayColor,
                                    fontSize: 12
                                }}>{author.summary}</Text> : null
                            }
                        </View>
